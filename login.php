                      ...
                      <div class="row d-flex align-items-center justify-content-center">
                        ...
                        <div class="col-12 col-lg-7 col-md-12">
                          <div class="cta-text-box">
                            <form name="login-form" class="cta-form" action="Action/login-action.php" method="post">
                              <div class="mb-3">
                                <label for="email">
                                  <ion-icon name="mail"></ion-icon>
                                  Email
                                </label>
                                <input class="form-contol" id="email" name="email" type="email" placeholder="me@example.com" required />
                              </div>
                              ...
                              <div class="mb-3">
                                ...
                                <input class="form-contol" id="password" name="password" type="password" placeholder="Password" required />
                              </div>
