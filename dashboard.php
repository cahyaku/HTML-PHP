...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;700&family=Rubik:wght@400;500;700&display=swap"
          rel="stylesheet"/>
    ...
    <nav class="navbar bg-body-tertiary navbar-background">
        <div class="container-fluid">
            <div class="d-flex align-items-center">
                <button class="btn-nav d-lg-none" type="button" data-bs-toggle="offcanvas"
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="d-none d-lg-block">
                    <a class="person-link" href="edit-profile.php">me@example.com</a>
                </div>
            </div>
        </div>
    </nav>
